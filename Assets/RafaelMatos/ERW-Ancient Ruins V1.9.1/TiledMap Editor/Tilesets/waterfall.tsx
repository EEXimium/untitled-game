...
<tileset version="1.9" tiledversion="1.9.2" name="waterfall" tilewidth="32" tileheight="32" tilecount="209" columns="19">
 <image source="../../Tilesets/waterfall.png" width="608" height="352"/>
 <tile id="1">
  <animation>
